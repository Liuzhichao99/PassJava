<template>
  <el-dialog
    ...
    <el-form-item label="类型logo路径" prop="logoUrl">
      <el-input v-model="dataForm.logoUrl" placeholder="类型logo路径"></el-input>
    </el-form-item>
          ...
          if (this.dataForm.id) {
            this.$http({
              ...
              if (data && data.code === 0) {
                ...
                this.dataForm.delFlag = data.type.delFlag
                this.dataForm.createTime = data.type.createTime
                this.dataForm.updateTime = data.type.updateTime
              }
            })
          }
        })
